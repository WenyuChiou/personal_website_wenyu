        ...
        "items": [
            {
                ...
                "fullDescription": {
                    ...
                    "zh": "本專案開發一個全面的代理人基模型系統，用於模擬家庭對洪水風險的長期調適。框架整合保護動機理論（PMT）與保護行動決策模型（PADM）來呈現認知決策過程。它區分多數群體（MG）與非多數群體（NMG）家庭，以考慮資源、風險感知與調適能力的社會異質性。模型與危害模組（洪水深度網格）、暴露追蹤、脆弱性評估及家庭財務模擬耦合。"
                },
